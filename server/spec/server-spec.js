...
describe('Persistent Node Chat Server', () => {
  ...
  it('Should output all messages from the DB', (done) => {
    // Let's insert a message into the db
       const queryString = 'INSERT INTO messages(messageText, timeCreated, room_id, user_id) VALUES (?, ?, ?, (SELECT id FROM users WHERE username = ?))';
       const queryArgs = [req.body.messageText, req.body.timeCreated, req.body.roomname, req.body.username];
